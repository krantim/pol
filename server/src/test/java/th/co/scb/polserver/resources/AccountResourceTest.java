...
public class AccountResourceTest {
    ...
    public void shouldReturnDetailForGivenAccount() throws Exception {
        ...
        when(mockClient.fetch(eq("accountEndpoint/123"), any(Class.class))).thenReturn(mockEasyNetResponse);
        ...
        EasyNetEndpoints mockEndpoints = mock(EasyNetEndpoints.class);
        when(mockEndpoints.getAccountUrl()).thenReturn("accountEndpoint");

        Account actualAccount = new AccountResource(mockClient, mockMapper, mockEndpoints).getAccountDetail("userid", "123");
